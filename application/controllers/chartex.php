...
***************/
	...
	//index function: includes page header, footer and viewer frames, and also sets up the search fields.
	...
	//results function: generates the results tables. Called twice in succession, from global.js for the documents and entities searches.
	...
	{			
		...
		//Checks whether the search field, collections checkboxes and entities checkboxes have been completed.
		...
		//Then, depending on which search has been called (documents or entities), it sends a database query.	
		//Then outputs the results of the search query to a table.
	...
	//document_viewer function: not called via a URI, this creates a placeholder for the Document Viewer.
	public function document_viewer()
	{
		$this->load->view('chartex/document_viewer');
	}
	//entity_viewer function: not called via a URI, this creates a placeholder for the Entity Viewer.
...
***************/	
	...
	//document function: gets details about a document and the entities marked up within that document and populates a visualisation. 
...
***************/
	...
	//Function has been designed (so far) to work with the Person and Site entity types. 
	//It will cope with other entity types but provide a more generic response.
	//Different visualisation options are available (HTML nested list, JSTree visualisation, and JIT Visualisation.
